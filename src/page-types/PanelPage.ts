...
abstract class BasePanelPage<I extends string>
  implements RepresentsRoutes<PanelRoutePartial>, HasId<I>
{
...
export class PanelPageWithParams<I extends string, T extends string>
  extends BasePanelPage<I>
  implements PageWithParams<T>, HasId<I>
{
  hasParams: true = true;
  constructor(
    public id: I,
    public path: string,
    public paramKeys: readonly T[],
    modals: AnySubPage[] = [],
  ) {
    super(id, path, modals);
  }
...
export function createPanel<
  T extends string,
  A extends AnySubPage,
  B extends AnySubPage,
  C extends AnySubPage,
  D extends AnySubPage,
  E extends AnySubPage,
  F extends AnySubPage,
  G extends AnySubPage,
  H extends AnySubPage,
  I extends AnySubPage,
  J extends AnySubPage,
>(
  id: T,
  path: string,
  modals: [A, B, C, D, E, F, G, H, I, J],
): AddChild<
  AddChild<
    AddChild<
      AddChild<
...
export function createPanel<T extends string, A extends AnySubPage, B extends AnySubPage>(
  id: T,
  path: string,
  modals: [A, B],
): AddChild<AddChild<PanelPage<T>, A>, B>;
export function createPanel<T extends string, A extends AnySubPage>(
  id: T,
  path: string,
  modals: [A],
): AddChild<PanelPage<T>, A>;
export function createPanel<T extends string>(
  id: T,
  path: string,
  modals?: AnySubPage[],
): PanelPage<T>;
...
>(
  ...
  modals: [A, B, C],
  paramKeys: readonly P[],
): AddChild<AddChild<AddChild<PanelPageWithParams<T, P>, A>, B>, C>;
export function createPanel<
  T extends string,
  P extends string,
  A extends AnySubPage,
...
>(
  ...
  modals: [A, B],
  paramKeys: readonly P[],
): AddChild<AddChild<PanelPageWithParams<T, P>, A>, B>;
export function createPanel<T extends string, P extends string, A extends AnySubPage>(
  id: T,
  path: string,
  modals: [A],
  paramKeys: readonly P[],
): AddChild<PanelPageWithParams<T, P>, A>;
export function createPanel<T extends string, P extends string>(
  id: T,
  path: string,
  modals: AnySubPage[],
  paramKeys: readonly P[],
): PanelPageWithParams<T, P>;
export function createPanel<T extends string, P extends string>(
  id: T,
  path: string,
  modals?: AnySubPage[],
