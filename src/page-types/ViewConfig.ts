...
export class ViewConfig<T extends string>
  implements HasId<T>, HasChildren<AnyPanel>, RepresentsRoutes<ViewRoutePartial>
{
      ...
      AddChild<
        AddChild<
          AddChild<
            AddChild<
              AddChild<
                AddChild<AddChild<AddChild<AddChild<AddChild<ViewConfig<T>, A>, B>, C>, D>, E>,
                F
              >,
              G
            >,
...
>(
  ...
  AddChild<
    AddChild<
      AddChild<
        AddChild<AddChild<AddChild<AddChild<AddChild<AddChild<ViewConfig<T>, A>, B>, C>, D>, E>, F>,
        G
      >,
      H
    >,
...
export function createView<T extends string, A extends AnyPanel, B extends AnyPanel>(
  id: T,
  panels: [A, B],
): AddChild<AddChild<ViewConfig<T>, A>, B>;
export function createView<T extends string, A extends AnyPanel>(
  id: T,
  panels: [A],
): AddChild<ViewConfig<T>, A>;
