...
abstract class BaseTabPage<I extends string>
  implements RepresentsRoutes<TabRoutePartial>, HasId<I>
{
...
export class TabPageWithParams<I extends string, T extends string>
  extends BaseTabPage<I>
...
export function createTab<
  ...
  D extends AnyModalPage,
  E extends AnyModalPage,
  F extends AnyModalPage,
>(
  id: T,
  path: string,
  modals: [A, B, C, D, E, F],
...
export function createTab<T extends string, A extends AnyModalPage, B extends AnyModalPage>(
  id: T,
  path: string,
  modals: [A, B],
): AddChild<AddChild<TabPage<T>, A>, B>;
export function createTab<T extends string, A extends AnyModalPage>(
  id: T,
  path: string,
  modals: [A],
): AddChild<TabPage<T>, A>;
export function createTab<T extends string>(
  id: T,
  path: string,
  modals?: AnyModalPage[],
): TabPage<T>;
...
>(
  ...
  modals: [A, B, C],
  paramKeys: readonly P[],
): AddChild<AddChild<AddChild<TabPageWithParams<T, P>, A>, B>, C>;
export function createTab<
  T extends string,
  P extends string,
  A extends AnyModalPage,
...
>(
  ...
  modals: [A, B],
  paramKeys: readonly P[],
): AddChild<AddChild<TabPageWithParams<T, P>, A>, B>;
export function createTab<T extends string, P extends string, A extends AnyModalPage>(
  id: T,
  path: string,
  modals: [A],
  paramKeys: readonly P[],
): AddChild<TabPageWithParams<T, P>, A>;
export function createTab<T extends string, P extends string>(
  id: T,
  path: string,
  modals: AnyModalPage[],
  paramKeys: readonly P[],
): TabPageWithParams<T, P>;
export function createTab<T extends string, P extends string>(
  id: T,
  path: string,
  modals?: AnyModalPage[],
