...
- Добавили поддержку @vkontakte/vk-bridge v3.0.0

v1.8.5

- Обновили peer зависимости
- Добавили поддержку @vkontakte/vkui v8.0.0

v1.8.4

- Исправлена обработка прямых ссылок на корень приложения без hash-фрагмента.
